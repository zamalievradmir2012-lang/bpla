...
Config.BUNKER_POS = Vector3.new(0, 16, -2100)   -- бункер далеко к северу от города, выше земли
Config.LOBBY_POS  = Vector3.new(0, 420, -2400)  -- лобби ещё дальше, в небе
Config.PAD_POS    = Vector3.new(0, 90, -1650)   -- взлётная полоса в открытом небе, не на крыше
...
Config.DRONES = {
	...
	},
	{
		...
		Desc="Барражирующий боеприпас с X-крылом. Тихий электромотор. ЛКМ — захват цели кликом (квадрат-маркер), дрон сам пикирует на неё. SPACE — ручной подрыв. C — барражирование. Пикирование до 200 studs/s. Взрыв: R=20, 120 HP, игнорирует 50% защиты щитов.",
	},
	{
	...
	{
		Id="termit", Name="«Термит»", Price=450, Control="B", Kind="kamikaze",
		Speed=115, Turn=150, HP=35, Ammo=1, BRadius=13, BDamage=70, FireTime=40, Fuel=150,
		Reward=40, Flags={},
		Sound={Key="Motor", Pitch=2.4, Volume=0.5, MaxDistance=230},
		Desc="FPV-камикадзе с термобарической боевой частью. Взрыв слабее «Упыря» по радиусу (R=13, 70 HP), но выжигает всё внутри: пожар 40 секунд, отлично против ангаров и техники.",
	},
	{
		Id="strizh", Name="«Стриж»", Price=2600, Control="A", Kind="missile",
		Speed=170, Turn=90, HP=60, Ammo=2, BRadius=16, BDamage=60, FireTime=0, Fuel=150,
		Reward=70, Flags={Marker=true},
		Sound={Key="Jet", Pitch=1.6, Volume=0.55, MaxDistance=300},
		Desc="Скоростной реактивный разведчик-целеуказатель. 2 лёгкие ракеты (R=16, 60 HP). E — режим камеры с маркером цели. Минимальная скорость — самолёт не умеет висеть на месте!",
	},
	{
		Id="uley", Name="«Улей»", Price=4200, Control="A", Kind="bomber",
		Speed=55, Turn=70, HP=150, Ammo=8, BRadius=9, BDamage=40, FireTime=6, Fuel=240,
		Reward=90, Flags={},
		Sound={Key="Motor", Pitch=1.4, Volume=0.7, MaxDistance=280},
		Desc="Тяжёлый восьмивинтовой бомбовоз. 8 осколочных бомб (R=9, 40 HP) — ковровое бомбометание по кварталам. Медленный и живучий: 150 HP.",
	},
	{
...
-- Тротуар у перекрёстка (дорога ±10, тротуар до ±16). Не в центре дома.
Config.DEF_SPAWNS = {
	Vector3.new(14, 4, 14),
	Vector3.new(-782, 4, 14),
	Vector3.new(782, 4, 14),
	Vector3.new(14, 4, -782),
	Vector3.new(14, 4, 782),
	Vector3.new(526, 4, -782),
	Vector3.new(-526, 4, 782),
	Vector3.new(782, 4, -526),
	Vector3.new(-782, 4, 526),
	Vector3.new(-270, 4, 270),
}
...
Config.REM = {
	...
	DroneUnlocked = "DroneUnlocked",  -- S→C ({droneId=true,...}) — купленные навсегда дроны
}
